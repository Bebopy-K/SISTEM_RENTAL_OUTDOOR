    ...
    */
    ...
    'connections' => [
        ...
        'pgsql' => [
            ...
            'url' => env('DB_MYSQL_URL'),
            'host' => env('DB_MYSQL_HOST'),
            'port' => env('DB_MYSQL_PORT', '5432'),
            'database' => env('DB_MYSQL_DATABASE'),
            'username' => env('DB_MYSQL_USERNAME'),
            'password' => env('DB_MYSQL_PASSWOR'),
            'charset' => 'utf8',
            'prefix' => '',
            'prefix_indexes' => true,
            'search_path' => 'public',
        ...
        'dwh' => [
            'driver' => 'pgsql',
            'url' => env('DB_DWH_URL'),
            'host' => env('DB_DWH_HOST'),
            'port' => env('DB_DWH_PORT'),
            'database' => env('DB_DWH_DATABASE'),
            'username' => env('DB_DWH_USERNAME'),
