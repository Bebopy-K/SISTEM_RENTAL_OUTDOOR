    ...
    <div class="row justify-content-center w-100">
        <div class="col-md-5 col-lg-4">
            ...
            <div class="card border-0 shadow-sm bg-white p-4 rounded-3">
                ...
                {{-- FORM LOGIN DENGAN USERNAME ATAU EMAIL --}}
                <form method="POST" action="/login">
                    @csrf
                    
                    <div class="mb-3">
                        <label class="form-label text-secondary fw-bold small">Username atau Email</label>
                        <div class="input-group">
                            <span class="input-group-text bg-light text-muted border-end-0">
                                <i class="fas fa-user small"></i>
                            </span>
                            <input type="text" name="username" class="form-control border-start-0 ps-0" placeholder="Masukkan username atau email Anda" value="{{ old('username') }}" required autofocus>
                        </div>
                    </div>
